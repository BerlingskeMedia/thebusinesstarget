<?php
  ...
  $url_format = "http://apps.adlifter.com/plugin/?application_key=70c4dd8af56f5dad9d5483513f049eb6&command=cmd_berlingske_user_profile_set&customer_key=a40e4703a823d1d11977928620c6ead0&stack_key=30f3acff061bdc073a16a7d02d2c7d90&&user_id=%s&nyhedsbreve=%s";

  $id = $request->id;
  $nlid = $request->nlid;

  $url = sprintf($url_format, $id, $nlid);
